...
<html lang="en">
  ...
  <section>
    ...
    <div class="container">
      <div class="row" style="padding-top: 70px; padding-bottom: 70px;">
        <h2 class="col-12 mb-4 pl-5">MY SKILLS</h2>
        <div class="col-md-6">
          <div class="row px-5">
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic </p>
          </div>
  ...
  <section style="padding-top: 70px; padding-bottom: 70px;">
    <div class="container">
      <div class="row">
        <h2 class="mx-auto pb-5">MY PORTFOLIO</h2>
      </div>
      <div class="card-deck">
        <div class="card">
        ...
        <div class="card">
          <a href="">
          <img class="card-img-top" src="portfolio1.jpg" style="height: 150px;"></a>
        </div>
      </div>
  ...
  <footer class="container-fluid py-3" style="background: #111;">
    <p class="text-center text-white">© 2018 - All Rights Reserved.</p>
  </footer>
